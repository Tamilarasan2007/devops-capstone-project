...
![Build Status](https://github.com/Tamilarasan2007/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)
...
Customer Accounts microservice for an e-commerce application, developed as a RESTful service using test-driven development.
